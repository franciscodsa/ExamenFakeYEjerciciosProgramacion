...
public class Defensores extends Jugador{
    ...
    public Defensores(String nombre, int dorsal, int numeroDeGoles, int pasesExitosos, int balonesRecuperados) {
        super(nombre, dorsal);
    ...
    public int valorarJugador() {
        return (this.numeroDeGoles * 20) + this.pasesExitosos + (this.balonesRecuperados * 4);
    }
}
